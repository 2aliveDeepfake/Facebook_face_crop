...
# 크롭 완료한 폴더
folder_path = "G:\\DFDC_img\\dfdc_train_part_04\\dfdc_train_04_fake_crop\\"
folder_list = os.listdir(folder_path)
# keep 폴더 내부 폴더명 가져오기 => keep 내부에 폴더가 없다면 관련 코드 지워도 됨
# print(folder_list)

# 크롭 안된 폴더
input_dir = "G:\\DFDC_img\\dfdc_train_part_04\\dfdc_train_04_fake\\"
...
for input_name in input_list:
    ...
    for item in folder_list:  # 각 폴더 이름(hood_T)의 파일이름 얻기
        ...
        if (filename == inputname):
            ...
            shutil.move(input_dir+input_name, "G:\\DFDC_img\\dfdc_train_part_04\\dfdc_train_04_fake_done\\"+input_name)
